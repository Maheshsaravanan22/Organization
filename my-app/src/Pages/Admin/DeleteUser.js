...
function DeleteUser() {
 ...
 setUserdata(res.data);
  console.log(res.data);
        ...
        console.log("Error while using getuser api in DeleteUser",err.message);
    }
}
  ...
  const deleteuser = async (id, name) => {
    try{
        const res = await axios.delete(`http://localhost:4001/deleteuser/${id}`)
       setUserdata(res.data);
        console.log(res.data);
          }
          catch(err){
              console.log("Error while using delete api in DeleteUser",err.message);
          }
    }
